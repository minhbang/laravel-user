    ...
    <div class="row">
        <div class="col-sm-6">
            <div class="form-group">
                <label class="col-xs-3 control-label">{{ __('Parent group') }}</label>
                <div class="col-xs-9">
                    <p class="form-control-static text-primary">{{ $parent_title }}</p>
                </div>
            </div>
            <div class="form-group{{ $errors->has('full_name') ? ' has-error':'' }}">
                {!! Form::label('label', __('Fullname'), ['class' => 'col-xs-3 control-label']) !!}
                <div class="col-xs-9">
            ...
            <div class="form-group{{ $errors->has('system_name') ? ' has-error':'' }}">
                {!! Form::label('system_name', __('System name'), ['class' => 'col-xs-3 control-label']) !!}
                <div class="col-xs-9">
        ...
        <div class="col-sm-6">
            <div class="form-group">
                ...
                <div class="col-xs-9">
                    <p class="form-control-static text-warning"><strong>{{__('Additional information')}}</strong></p>
                </div>
            </div>
